...
public class Crud extends JFrame {
    ...
    public Crud() {
        ...
        labelNascimento.setBounds(500, 30, 200, 30);
        ...
        labelAcoes.setBounds(750, 30, 100, 30);
        ...
        labelIconLine.setBounds(0, 70, 1000, 2);
        ...
        labeliconHome.setBounds(40, 150, 32, 32);
        sidebarPanel.add(labeliconHome);
        btnHome = new JButton("Home");
        btnHome.setBounds(80, 150, 120, 40);
        ...
        labeliconPacientes.setBounds(40, 220, 32, 32);
        sidebarPanel.add(labeliconPacientes);
        btnPacientes = new JButton("Cadastro");
        btnPacientes.setBounds(80, 220, 120, 40);
        ...
        labeliconLogOut.setBounds(40, 290, 32, 32);
        sidebarPanel.add(labeliconLogOut);
        btnLogOut = new JButton("Sair");
        btnLogOut.setBounds(80, 290, 120, 40);
    ...
    private void carregarPacientes() {
        ...
        for (Component comp : componentes) {
            if (comp instanceof JLabel && comp != labelIconLine &&
                !comp.getBounds().equals(new Rectangle(100, 30, 200, 30)) &&
                !comp.getBounds().equals(new Rectangle(300, 30, 200, 30)) &&
                !comp.getBounds().equals(new Rectangle(500, 30, 200, 30)) &&
                !comp.getBounds().equals(new Rectangle(750, 30, 100, 30))) {
